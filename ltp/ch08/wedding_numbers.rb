# week 3 :: chapter 8 LTP :: Mark Hutchison
def weddingNumber number
  ...
  if write > 0
    ...
    #  we originally called weddingNumber with 1999 (so "number" = 1999),
    #  then at this point "write" would be 19, and "left" would be 99.
    #  The laziest thing to do at this point is to have weddingNumber
    #  write out the 'nineteen' for us, then we write out ' hundred',
    #  and then the rest of weddingNumber writes out 'ninety-nine'.
